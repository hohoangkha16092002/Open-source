...
<head>
    ...
    <title>CHỈNH SỬA SẢN PHẢM</title>
...
if (isset($_GET['MaMH'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update'])) {
        ...
        $sql_update = "UPDATE mathang SET TenMH = '$TenMH', MaLMH='$LoaiMH', MaHSX='$HSX' , SoLuong='$SoLuong',
                MoTaMH='$MoTa', IDAnhMH='$AnhSP', MaKM='$KhuyenMai', CPU='$CPU', RAM='$RAM', LuuTru='$ODia', HDH='$HDH', ManHinh= '$ManHinh', 
                DoHoa ='$VGA', PIN='$PIN', KhoiLuong='$KhoiLuong', PhuKien='$PhuKien' 
                WHERE  MaMH = '$MaMH'";
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    <div class="mb-3">
                        <h1 class="h3 d-inline align-middle">SỬA MẶT HÀNG</h1>
                    </div>
                    <form method="post">
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <input type="text" class="form-control" name="TenMH" placeholder="Tên mặt hàng"
                                            value="<?php echo $product['TenMH']; ?>" />
                                    </div>
                                    <div class="card-body">
                                        <label class="form-label">Loại mặt hàng</label>
                                        <select class="form-select" name="LoaiMH">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <select class="form-select" name="TenHSX">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <textarea class="form-control" rows="2" name="MoTaMH"
                                            placeholder="Mô tả"><?php echo htmlspecialchars($product['MoTaMH']); ?></textarea>
                                    </div>
