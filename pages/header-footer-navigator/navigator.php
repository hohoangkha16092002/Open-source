    ...
    <div id="mainNavigationBar" class="nav-main">
        <div class="teko-row teko-row-center nav-navbar">
            <div class="teko-row teko-row-no-wrap teko-row-middle nav-subnav"
                ...
                <div class="teko-col nav-product-portfolio"
                ...
                <div class="teko-col nav-common-form nav-ip--has-popup" style="padding-left: 8px; padding-right: 8px; flex: 0 0 auto;">
                    <div>
                        <div>
                            <div class="button nav-ip-main" data-content-region-name="headerBar"
                            ...
                            <div class="nav-ip-popup-main">
                                <div class="nav-ip-popup-top">
                                    ...
                                    <div data-content-region-name="headerBar" data-track-content="true"
                                        ...
                                        <div class="icon"><svg fill="none" viewBox="0 0 24 24" size="18"
                ...
                <div class="teko-col nav-common-form nav-notify--has-popup " style="padding-left: 8px; padding-right: 8px; flex: 0 0 auto;">
                    <div class="nav-notify" data-content-region-name="headerBar" data-track-content="true"
                        ...
                        <div class="nav-notity-popup"
                            style="position: absolute; inset: 72px 300px auto auto;"
                            data-popper-reference-hidden="false" data-popper-escaped="false"
