...
<body>
                    ...
                    <div class="css-117j3zt">
                        <div class="css-8x68m">
                            <div class="css-1knbux5">
                                <div type="title" class="att-gio-hang css-1cp1h79">Giỏ hàng</div><button id="delete-all-product" class="att-delete-all-btn css-tj2ae3">Xóa tất cả</button>
                            </div>
                        </div>
                                ...
                                <div class="card-body css-0">
                                    <div class="teko-row teko-row-space-between teko-row-middle css-8m0ae5">
                                        <div class="teko-col css-17ajfcv" style="flex: 0 0 4%;"><label class="check-box css-1u2186j">
                                                <div class="css-l24w9c"><input type="checkbox" class="att-uncheck-all-product css-lc01j1" checked="">
                                                ...
                                                <div class="teko-row teko-row-space-between css-1qrgscw">
                                                    ...
                                                    <div class="teko-col teko-col-2 css-17ajfcv">
                                                        <div class="css-1oskuwq">
                                                            ...
                                                            <button type="body" id="delete-one-product" class="att-delete-all-btn css-3c7poi">Xóa</button>
                                                        </div>
                                                    </div>
                                                    <div class="teko-col teko-col-2 css-17ajfcv">
                                                        <div class="teko-col css-17ajfcv">
    ...
    <div id="teko-modal-loiets79gktfazimh1v" class="teko-modal-container" style="position: fixed; inset: 0px; z-index: 1051; display: none; justify-content: center; align-items: center; background: rgba(0, 0, 0, 0.1);">
        <div class="css-1272naz"></div>
        <div class="teko-modal teko-modal-show css-t2ptn2" style="opacity: 1; transform: translateY(0px); width: 400px;">
            <div class="teko-modal-content"><svg fill="none" viewBox="0 0 24 24" class="teko-modal-close css-1qzn8fv" size="24" color="#000000" height="24" width="24" xmlns="http://www.w3.org/2000/svg" onclick="closeModalOneProduct()">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M6.81304 5.75263C6.52015 5.45974 6.04528 5.45974 5.75238 5.75263C5.45949 6.04552 5.45949 6.5204 5.75238 6.81329L10.8789 11.9398L5.75241 17.0663C5.45952 17.3592 5.45952 17.8341 5.75241 18.127C6.0453 18.4199 6.52018 18.4199 6.81307 18.127L11.9396 13.0005L17.0661 18.127C17.359 18.4199 17.8339 18.4199 18.1268 18.127C18.4196 17.8341 18.4196 17.3592 18.1268 17.0663L13.0002 11.9398L18.1268 6.81329C18.4197 6.5204 18.4197 6.04552 18.1268 5.75263C17.8339 5.45974 17.359 5.45974 17.0661 5.75263L11.9396 10.8792L6.81304 5.75263Z" fill="#82869E"></path>
                </svg>
                ...
                <div class="teko-modal-body">
                    <div type="body" class="css-1lchwqw" style="text-align: center;">Bạn muốn xoá sản phẩm này ra khỏi giỏ hàng?</div>
                    <div class="teko-modal-footer teko-modal-footer-center"><button height="2.5rem" class="css-12b53wj" type="button" onclick="closeModalOneProduct()">
                            <div type="body" class="button-text css-1lchwqw">Hủy bỏ</div>
                            <span style="margin-left: 0px;">
                                <div class="css-157jl91"></div>
                            </span>
                        </button><button height="2.5rem" color="white" class="css-fhio94" type="button" onclick="confirmDeleteOneProduct()">
                            <div type="body" class="button-text css-2h64mz" color="white">Đồng ý</div><span style="margin-left: 0px;">
                                <div class="css-157jl91"></div>
                            </span>
                        </button>
                    </div>
    ...
    <div id="teko-modal-loimegrzs96o8wkenua" class="teko-modal-container" style="position: fixed; inset: 0px; z-index: 1051; display: none; justify-content: center; align-items: center; background: rgba(0, 0, 0, 0.1);">
        <div class="css-1272naz"></div>
        <div class="teko-modal teko-modal-show css-t2ptn2" style="opacity: 1; transform: translateY(0px); width: 400px;">
            <div class="teko-modal-content"><svg fill="none" viewBox="0 0 24 24" class="teko-modal-close css-1qzn8fv" size="24" color="#000000" height="24" width="24" xmlns="http://www.w3.org/2000/svg" onclick="closeModalAllProduct()">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M6.81304 5.75263C6.52015 5.45974 6.04528 5.45974 5.75238 5.75263C5.45949 6.04552 5.45949 6.5204 5.75238 6.81329L10.8789 11.9398L5.75241 17.0663C5.45952 17.3592 5.45952 17.8341 5.75241 18.127C6.0453 18.4199 6.52018 18.4199 6.81307 18.127L11.9396 13.0005L17.0661 18.127C17.359 18.4199 17.8339 18.4199 18.1268 18.127C18.4196 17.8341 18.4196 17.3592 18.1268 17.0663L13.0002 11.9398L18.1268 6.81329C18.4197 6.5204 18.4197 6.04552 18.1268 5.75263C17.8339 5.45974 17.359 5.45974 17.0661 5.75263L11.9396 10.8792L6.81304 5.75263Z" fill="#82869E"></path>
                </svg>
                <div class="teko-modal-body">
                    ...
                    <div class="teko-modal-footer teko-modal-footer-center"><button height="2.5rem" class="css-12b53wj" type="button" onclick="closeModalAllProduct()">
                            <div type="body" class="button-text css-1lchwqw">Hủy bỏ</div><span style="margin-left: 0px;">
                                <div class="css-157jl91"></div>
                            </span>
                        </button><button height="2.5rem" color="white" class="att-approved-remove-all-cart-items css-fhio94" type="button" onclick="confirmDeleteAllProduct()">
                            <div type="body" class="button-text css-2h64mz" color="white">Đồng ý</div><span style="margin-left: 0px;">
                                <div class="css-157jl91"></div>
                            </span>
                        </button></div>
