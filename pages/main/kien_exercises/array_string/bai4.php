...
<body>
    ...
    <form action="" name="search" method="post">
        <table style="background-color: lightseagreen;">
            <tr>
                <th colspan="2" style="background-color: aquamarine; color: white">TÌM KIẾM</th>
            </tr>
            <tr>
                <td>Nhập mảng:</td>
                <td>
            ...
            <tr>
                <td></td>
                <td>
                    <input type="submit" name="search" style="background-color: lightblue;" value="Tìm kiếm">
                </td>
            </tr>
            <tr>
                <td>Mảng:</td>
