...
<body>
    <?php
        if(isset($_POST['submit'])){
            ...
            $mang_hinh = array("hoi.jpg", "ty.png", "trau.jpg", "dan.jpg", "meo.jpg", "thin.jpg", "ran.jpg", "ngo.jpg", "mui.jpg", "than.jpg", "dau.jpg", "tuat.jpg");
            $nam = $_POST['year'];
            $year = $nam-3;
            $can = $year%10;
            $chi = $year%12;
            ...
            $hinh = $mang_hinh[$chi];
            $hinh_anh = "<img src='images/$hinh' alt='Images' width='200px' height='200px'>";
        }
    ?>
    <form action="" method="post">
        <table style="background-color: lightcyan;">
            <tr>
                <th colspan="3" style="text-align: center; background-color: darkcyan; color: white">TÍNH NĂM ÂM LỊCH</th>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="center">
                    <input style="color: red; font-weight: bold; background-color: yellow;" type="text" name="lunarYear" value="<?php
