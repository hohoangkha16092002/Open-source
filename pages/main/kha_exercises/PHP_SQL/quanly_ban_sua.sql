...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 17, 2023 at 02:17 PM
...
('kh009', 'Hồ Hoàng Kha', 0, '2 Nguyễn Đình Chiểu', '0934833527', 'matcova337@gmail.com');
...
('NTF008', 'NutiMilk Sữa tươi 100 điểm Ít đường', 'NTF', 'ST', 180, 15000, 'NutiMilk Sữa tươi 100 điểm - Sữa tươi chuẩn cao thế giới với 3,5g Đạm và 4,0g Béo', 'Trang trại Bò sữa NutiMilk được xây dựng trên cao nguyên Gia Lai (xã Đăk Yă, huyện Mang Yang, tỉnh Gia Lai) có độ cao 800 m so với mực nước biển. Hội đủ 6 yếu tố ưu việt nhất: Đất sạch – Không khí sạch – Nước sạch – Cỏ sạch – Nhiệt độ mát 21-25 độ C – Sản lượng 25 lít sữa/ngày/con bò (không khai thác ở mức tối đa để đảm bảo sữa có chất lượng tốt nhất).\r\n\r\nNhờ thừa hưởng tất cả yếu tố “thiên thời địa lợi nhân hòa” về điều kiện tự nhiên, phương pháp chăn nuôi và sự tham gia của các chuyên gia từ Thụy Điển, dòng sản phẩm NutiMilk Sữa tươi 100 điểm có hàm lượng dinh dưỡng lên đến 3,5g Đạm và 4,0g Béo trong 100 ml, tương đương sữa tươi ngoại nhập.\r\n\r\nBên cạnh những hương vị quen thuộc, NutiMilk Sữa tươi 100 điểm mang đến hương vị mới lạ là Sữa tươi Đường đen. Sự kết hợp giữa đường đen và sữa tươi mang đến loại thức uống vừa thơm ngon lại bổ dưỡng, tốt cho sức khỏe, được kỳ vọng sẽ trở thành thức uống được yêu thích và quen thuộc của mọi nhà.', 's-nutifood-180ml-1.png'),
...
('VNM013', 'Sưa tươi tiệt trùng ít đường', 'VNM', 'ST', 180, 30000, '100% sữa bò tươi nguyên chất từ những cô bò hạnh phúc được chăm sóc trong môi trường lý tưởng tại hệ thống 12 trang trại rộng lớn trải dài khắp Việt Nam, được ví nhưng những \"Resort bò sữa\", nơi các cô bò được ăn ngon, tắm mát, mát xa, nằm đệm.\r\nĐược bổ sung thêm Vitamin A, D3 và Selen giúp hỗ trợ miễn dịch cho cả gia đình.', 'Thơm ngon thuần khiết\r\nGiàu dưỡng chất tự nhiên tốt cho sức khỏe\r\nBổ sung Vitamin D3 theo chuẩn EFSA Châu Âu giúp hỗ trợ miễn dịch', 's_vinamilk_tuoi_itduong.png'),
('VNM014', 'Sữa Tươi Tiệt Trùng Vinamilk 100% Organic - Thùng 48 hộp 180ml', 'VNM', 'ST', 180, 463000, '123', '123', 's_vinamilk_tuoi_organic.jpg');
