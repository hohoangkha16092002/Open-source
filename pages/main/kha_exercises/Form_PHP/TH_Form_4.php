...
<body>
    ...
    <form method="post" name="tiendien">
        <table style="background: #ffe8fa; margin: 8% auto 0;">
            ...
            <tr>
                <td>Điểm chuẩn:</td>
                <td>
                    <input type="text" name="diemchuan" style="color: red;" size="20" value="<?php if (isset($diemchuan)) echo $diemchuan; ?>">
                </td>
            </tr>
            ...
            <tr>
                <td>Tổng điểm:</td>
                <td>
                    <input type="text" name="tong" size="20" readonly style="background: #fffee7" value="<?php if (isset($tong)) echo $tong; ?>">
                </td>
            </tr>
            ...
            <tr>
                <td>Kết quả thi:</td>
                <td>
                    <input type="text" name="ketqua" size="20" readonly style="background: #fffee7" value="<?php if (isset($ketqua)) echo $ketqua; ?>">
                </td>
            </tr>
            ...
            <tr>
                <th colspan="2" style="color: #edebde">
                    <?php
